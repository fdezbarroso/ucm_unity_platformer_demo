...
public class MovingPlatform : MonoBehaviour
{
    ...
    void _DoMovement()
    {
        ...
        Vector3 fromMeToWaypoint = m_CurrentWaypoint.position - transform.position;

        // TODO 2 - Mover la plataforma en función de la dirección obtenida, la velocidad, y el deltaTime
        transform.position += fromMeToWaypoint.normalized * m_MovementSpeed * Time.deltaTime;
    }
    ...
    void _CheckArrived()
    {
        ...
        Vector3 fromMeToWaypoint = m_CurrentWaypoint.position - transform.position;
        float remDist = fromMeToWaypoint.sqrMagnitude;
